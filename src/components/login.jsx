  ...
  return (
    <>
      <div className="flex flex-wrap shrink-0 items-center h-screen w-full justify-center">
        ...
        <div className="bg-[rgba(226,45,0,0.7)] text-[rgba(221,208,208)] shadow w-1/5 min-w-96 h-2/3  rounded-2xl font-bold text-center hover:blur-none duration-300 hover:bg-amber-600 transition-transform hover:scale-110  active:blur-none ">
